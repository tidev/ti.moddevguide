...
public class DemoView extends TiUIView {
    ...
    public void processProperties(KrollDict props) {
        ...
        if (props.containsKey(PROPERTY_COLOR)) {
            ...
            square.setBackgroundColor(TiConvert.toColor(props, PROPERTY_COLOR, TiApplication.getAppCurrentActivity()));
    ...
    public void setColor(String color) {
        ...
        int newColor = TiConvert.toColor(color, TiApplication.getAppCurrentActivity());
        View square = (View) getNativeView();
